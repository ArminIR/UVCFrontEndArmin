...
<body background="./fotos/grijzeachtergrond.jpg" id="achtergrondHome">
<div class="sidenav">
    <ul>
        ...
        <li><a href="https://learn.hz.nl/course/view.php?id=21135#section-1">
                <div class="tooltip"><img src="./fotos/Screenshot 2022-09-12 120355.jpg">
...
<div>
    <img id="setup" src="./fotos/unnamed.jpg" alt="Setup">
    <img id="foto" src="./fotos/coding-in-the-classroom.avif" alt="coding">
</div>
